        ...
        <div class="glass-card rounded-3xl shadow-2xl p-8">
            ...
            <form method="POST" action="/users" class="space-y-6">
                ...
                <div class="flex gap-4">
                    ...
                    <button type="submit" class="flex-1 bg-indigo-600 hover:bg-indigo-500 text-white py-3 px-6 rounded-xl font-semibold shadow-lg shadow-indigo-500/25 transition-all">Create User</button>
                </div>
            </form>
        </div>
    </div>
